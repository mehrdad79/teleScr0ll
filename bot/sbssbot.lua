...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {98797942},--Sudo users
    disabled_channels = {},
    moderation = {data = 'data/moderation.json'},
    about_text = [[teleScr0ll Bot V2 Beta
    An Advanced Anti Spam Bot worked On TeleSeed
